...
while cont=="s":
    ...
    print(f"Llevas {npart} partidas jugadas")
    o=conc.count("O")
    e=conc.count("E")
    u=conc.count("U")
    pvu=u*100/npart
    pvo=o*100/npart
    pve=e*100/npart
    print("El porcentage de victorias del usuario es: ",pvu,"%")
    print("El porcentage de victorias del ordenador es: ",pvo,"%")
    print("El porcentage de empates es: ",pve,"%")
